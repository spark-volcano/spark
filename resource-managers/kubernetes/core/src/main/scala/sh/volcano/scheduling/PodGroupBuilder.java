...
/**
 */
public class PodGroupBuilder implements VisitableBuilder<PodGroup, PodGroupBuilder> {
    private PodGroup podgroup;
    ...
    @Override
    public PodGroupBuilder accept(Visitor visitor) {
        return this;
    }
}